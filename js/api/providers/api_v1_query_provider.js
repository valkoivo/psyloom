...
import { ApiV1QueryData } from "../api_v1_query_data_object.js";
...
export class APIV1QueryProvider extends KoiAPISaveable(
	KoiProvider
) {

	static getTagName(){
		return 'api-v1-query-provider';
	}

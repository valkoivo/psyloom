/**
 * @module ApiV1AudienceProcessIdData
...
export class ApiV1AudienceProcessIdData extends KoiData {

	getProcessId(){
		return this._getValueOrDefaultValue('process_id');
	}

	setProcessId(new_id){
		this._properties['process_id'].setValue(new_id);
	}
	...
	constructProperties(){
		this._properties = {
			process_id: new KoiDataElementInteger({
				localized_name: 'process_id',
				default_value: null,
				allow_empty: true
			}),
